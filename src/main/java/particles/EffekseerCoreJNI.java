...
import java.io.IOException;
 ...
 class EffekseerCoreJNI {
    ...
    public final static native void EffekseerManagerCore_Pause(long jarg1, EffekseerManagerCore jarg1_, int handle , boolean pause);

    public final static native void EffekseerManagerCore_SetCameraPosition(long jarg1, EffekseerManagerCore jarg1_, float x, float y, float z);
    public final static native void EffekseerManagerCore_SetCameraRotate(long jarg1, EffekseerManagerCore jarg1_, float x, float y, float z);

    public final static native void EffekseerManagerCore_Camera_combined_3D(long jarg1, EffekseerManagerCore jarg1_, float[] tranlate , float[] rotate );
    ...
    public final static native void EffekseerManagerCore_SetViewProjectionMatrixWithSimpleWindowOrthogonal(long jarg1, EffekseerManagerCore jarg1_, int jarg2, int jarg3);
    public final static native void EffekseerManagerCore_SetViewProjectionMatrixWithSimpleWindowPerspective(

            long l, EffekseerManagerCore effekseerManagerCore, float i, float i1 , float[] up,float near, float far);
