...
public class GDXJNI {
  ...
  public final static native long new_EffekseerNode(long jarg1, EffekseerNode jarg1_, int jarg2);
  public final static native void delete_EffekseerNode(long jarg1);
  public final static native int EffekseerNode_GetPositionType(long jarg1, EffekseerNode jarg1_);
  public final static native int EffekseerNode_GetScaleType(long jarg1, EffekseerNode jarg1_);
  public final static native int EffekseerNode_GetRotacionType(long jarg1, EffekseerNode jarg1_);
  public final static native int EffekseerNode_getNodes(long jarg1, EffekseerNode jarg1_);
  public final static native long EffekseerNode_getNode(long jarg1, EffekseerNode jarg1_, int jarg2);
  public final static native String EffekseerNode_GetName(long jarg1, EffekseerNode jarg1_);
  public final static native void EffekseerNode_SetPosition(long jarg1, EffekseerNode jarg1_, int jarg2, float[] jarg3);
  public final static native long EffekseerNode_GetPosition(long jarg1, EffekseerNode jarg1_, int jarg2);
  public final static native void EffekseerNode_SetScale(long jarg1, EffekseerNode jarg1_, int jarg2, float[] jarg3);
  public final static native long EffekseerNode_GetScale(long jarg1, EffekseerNode jarg1_, int jarg2);
  public final static native void EffekseerNode_SetRotation(long jarg1, EffekseerNode jarg1_, int jarg2, float[] jarg3);
  public final static native long EffekseerNode_GetRotation(long jarg1, EffekseerNode jarg1_, int jarg2);
  public final static native int EffekseerNode_TranslationType(long jarg1, EffekseerNode jarg1_);
  public final static native int EffekseerNode_RotationType(long jarg1, EffekseerNode jarg1_);
  public final static native int EffekseerNode_ScalingType(long jarg1, EffekseerNode jarg1_);
  ...
  public final static native long EffekseerEffectCore_getNode(long jarg1, EffekseerEffectCore jarg1_);
  ...
  public final static native boolean EffekseerManagerCore_Initialize(long jarg1, EffekseerManagerCore jarg1_, int jarg2, int jarg3);
